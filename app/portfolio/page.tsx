...
export default function PortfolioPage() {
  return (
    <div className="container py-10">
      <div className="mb-10">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Investment Portfolio</h1>
        <p className="text-muted-foreground">Track my investment performance and portfolio allocation</p>
      </div>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-muted-foreground">
              The market continues to navigate through a high interest rate environment with inflation showing signs of
              moderation. Technology and healthcare sectors are showing resilience, while consumer discretionary faces
              headwinds from reduced consumer spending. Geopolitical tensions remain a concern for global markets.
            </p>
          </div>
          <div>
            <h3 className="font-semibold mb-2">Portfolio Strategy</h3>
            <p className="text-muted-foreground">
              Maintaining a balanced approach with a slight overweight in quality technology and healthcare companies
              with strong balance sheets and cash flows. Increasing allocation to dividend-paying stocks for income
              generation. Fixed income allocation focused on shorter duration to manage interest rate risk. Maintaining
              gold position as a hedge against geopolitical uncertainty.
            </p>
          </div>
          <div>
            <h3 className="font-semibold mb-2">Risk Management</h3>
            <p className="text-muted-foreground">
              Diversification across sectors and asset classes remains the primary risk management strategy. Position
              sizing is carefully managed with no single equity position exceeding 15% of the portfolio. Maintaining a
              cash position of approximately 5% to capitalize on potential market dislocations.
            </p>
          </div>
        </CardContent>
      </Card>
