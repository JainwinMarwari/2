...
export default function ArticlesPage() {
  return (
    <div className="container py-10">
      <div className="mb-10">
        <h1 className="text-3xl font-bold tracking-tight mb-2">Investment Articles & Analysis</h1>
        <p className="text-muted-foreground">
          In-depth research and insights on companies, sectors, and investment strategies
        </p>
      </div>
