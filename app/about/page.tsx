    ...
    <div className="container py-10">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground">
          Finance professional with a passion for investment analysis and portfolio management
        </p>
      </div>
        ...
        <div className="md:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardTitle className="text-center mt-4">John Smith, CFA Level II</CardTitle>
              <CardDescription className="text-center">Investment Analyst & Portfolio Manager</CardDescription>
            </CardHeader>
        ...
        <div className="md:col-span-2 space-y-8">
          <Card>
            ...
            <CardContent className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold">My Investment Philosophy</h3>
                <p className="mt-2 text-muted-foreground">
                  As a finance professional with a strong foundation in fundamental analysis and a CFA Level II
                  candidate, I approach investing with a disciplined, research-driven methodology. I believe in
                  identifying high-quality businesses with sustainable competitive advantages, strong management teams,
                  and healthy balance sheets. My investment horizon is typically long-term, focusing on companies that
                  can compound capital at above-average rates over extended periods.
                </p>
                <p className="mt-2 text-muted-foreground">
                  Risk management is central to my investment process. I emphasize portfolio diversification across
                  sectors and asset classes, careful position sizing, and maintaining a margin of safety in valuations.
                  I also integrate ESG considerations into my analysis, believing that companies with strong
                  environmental, social, and governance practices are better positioned for long-term success.
                </p>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Interested in discussing investment opportunities or professional collaboration? Get in touch.
              </CardDescription>
            </CardHeader>
            <CardContent>
